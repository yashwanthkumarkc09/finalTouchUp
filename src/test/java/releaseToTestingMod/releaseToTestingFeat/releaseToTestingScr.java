...
package releaseToTestingMod.releaseToTestingFeat;
import reuseablePackage.reuseFunction.yashwanthKumarKCClass;
import java.io.File;
...
public class releaseToTestingScr extends  AllActions {
	...
	catch(Exception e)
	{
        ...
        try
        {
            new yashwanthKumarKCClass(driver).yashwanthKumarKC("balakrishna@opaltechsolutions.com","Opal@1234");
